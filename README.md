...
The replication package contains five Stata do-files:
...
2. **`main.do`**: Main file that creates required folders, runs all programs in sequence and creates a log file
